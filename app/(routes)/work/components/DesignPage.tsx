...
const DesignPage: React.FC = () => {
  ...
  return (
    <>
   <div className="py-10">
  <h1 className="text-4xl text-center font-bold mb-10 montserrat text-[#1C3C3F]">DXN AYACUCHO</h1>
  <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 px-4 py-20">
    <div className="w-full lg:w-[60%]">
      ...
      >
        ...
        <h1 className="pt-5 text-lg lg:text-2xl text-[#1C3C3F] text-start font-semibold cursor-pointer montserrat">Catálogo de Productos</h1>
        <motion.div
...
<div className="py-10">
  <h1 className="text-4xl text-center font-bold mb-10 montserrat text-[#1C3C3F]">Eventos Ayacucho</h1>
  <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 px-4 py-20">
    <div className="w-full lg:w-[60%]">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
      ...
      >
        ...
        <h1 className="pt-5 text-lg lg:text-2xl text-[#1C3C3F] text-start font-semibold cursor-pointer montserrat">Catálogo de Eventos</h1>
        <motion.div
          className="overflow-hidden"
          initial={{ opacity: 0, height: 0 }}
          animate={{
      ...
      {[
        ...
        <motion.div key={index}>
          ...
          >
            ...
            <h1 className="pt-5 text-lg lg:text-2xl font-bold text-[#1C3C3F] text-start cursor-pointer montserrat">{item.title}</h1>
            <motion.div
              className="overflow-hidden"
              initial={{ opacity: 0, height: 0 }}
              animate={{
...
<div className="py-10">
  <h1 className="text-4xl text-center font-bold mb-10 montserrat text-[#1C3C3F]">Luromy</h1>
  <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 px-4 py-20">
    <div className="w-full lg:w-[60%]">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
      ...
      {[
        ...
        <motion.div key={index}>
          ...
          >
            ...
            <h1 className="pt-5 text-lg text-[#1C3C3F] lg:text-2xl font-bold text-start cursor-pointer montserrat">{item.title}</h1>
            <motion.div
              className="overflow-hidden"
              initial={{ opacity: 0, height: 0 }}
              animate={{
...
<div className="py-10">
  <h1 className="text-4xl text-center font-bold mb-10 montserrat text-[#1C3C3F]">GMACONS LLJ EIRL</h1>
  <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 px-4 py-20">
    <div className="w-full lg:w-[60%]">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
      ...
      >
        ...
        <h1 className="pt-5 text-lg lg:text-2xl text-[#1C3C3F] text-start font-semibold cursor-pointer montserrat">Servicios de la empresa</h1>
        <motion.div
      ...
      {[
        ...
        <motion.div key={index}>
          ...
          >
            ...
            <h1 className="pt-5 text-lg lg:text-2xl font-bold text-start  text-[#1C3C3F] cursor-pointer montserrat">{item.title}</h1>
            <motion.div
              className="overflow-hidden h-16"
              initial={{ opacity: 0, height: 0 }}
              animate={{
